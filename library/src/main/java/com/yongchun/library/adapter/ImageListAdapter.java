...
public class ImageListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void bindImages(ArrayList<ImageItem> images) {
        this.images = images;
    }

    public void bindSelectImages(ArrayList<ImageItem> images) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (getItemViewType(position) == TYPE_CAMERA) {
            ...
            final ImageItem image = images.get(showCamera ? position - 1 : position);

            Log.i("ImagePath", image.getImagePath());
            ...
            if (enablePreview) {
                contentHolder.check.setOnClickListener(v -> changeCheckboxState(contentHolder, image));
            }
    ...
    private void changeCheckboxState(ViewHolder contentHolder, ImageItem image) {
    ...
    public interface OnImageSelectChangedListener {
        void onChange(ArrayList<ImageItem> selectImages);

        void onTakePhoto();

        void onPictureClick(ImageItem media, int position);
    }
    ...
    public OnImageSelectChangedListener getOnImageSelectChangedListener() {
