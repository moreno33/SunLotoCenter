...
import com.sunlotocenter.dao.Loto5
...
class Loto5Fragment(private var addGameListener: AddGameListener) : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view= inflater.inflate(R.layout.fragment_loto5, container, false)
            ...
            showDialog(this.context!!, getString(R.string.option), content, getString(R.string.add), getString(R.string.cancel), object :ClickListener{
                override fun onClick(): Boolean {
                    ...
                    if(amount1.isNotEmpty()){
                        val loto5= Loto5(view.edxNumber.text, amount1.toDouble(), "1", 1)
                        addGameListener.addGame(loto5)
                    }
                    val amount2= content.edxAmount2.text
                    if(amount2.isNotEmpty()){
                        val loto5= Loto5(view.edxNumber.text, amount2.toDouble(), "2", 1)
                        addGameListener.addGame(loto5)
                    }
